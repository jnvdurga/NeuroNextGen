  ...
  return (
    <>
      ...
      <div className="pt-26 bg-black min-h-screen text-white">
        {/* Banner */}
        <div className="bg-[#111111] py-3 text-sm font-semibold text-center rounded mb-10 mx-4 sm:mx-auto max-w-5xl border border-gray-800 shadow-md tracking-wide uppercase text-gray-200 pt-6">
          🚀 We’re hiring skilled Developers and Engineers — join our AI, ML, Frontend, and Backend teams!
        </div>
