    ...
    <div className="min-h-screen bg-black text-white flex justify-center items-center pt-24">
      <section className="min-h-screen bg-black text-white px-6 md:px-20 py-16 flex flex-col lg:flex-row gap-10 justify-center">
        ...
        <div className="bg-[#121212] border border-gray-800 rounded-2xl p-8 w-full lg:w-1/2 space-y-6">
          <h2 className="text-2xl font-semibold">Let’s thrive together</h2>
        ...
        <div className="bg-[#0a0a0a] border border-gray-800 rounded-2xl p-8 w-full lg:w-1/2 flex flex-col justify-between">
          <div>
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              The future of AI depends not just on building larger models, but on creating
              rigorous evaluations, real-world benchmarks, and transparent performance
              metrics. Teams investing in structured AI testing and continuous validation
              will define the next generation of intelligent systems. It’s inspiring to
              see companies prioritizing measurable progress through data-driven evals and
              open leaderboards.
            </p>
          </div>
