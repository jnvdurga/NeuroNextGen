...
export default function ITDevelopment() {
  ...
  const featuresData = [
    {
      icon: "/it_development_icons.webp",
  ...
  return (
    <>
      ...
      <InfoSplitSection
        ...
        imageSrc="/Generated Image October 31, 2025 - 3_38PM.webp"
        reverse
