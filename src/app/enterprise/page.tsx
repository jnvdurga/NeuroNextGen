...
export default function EnterpriseSolutions() {
  ...
  const collectionData = [
    {
      image: "/Generated Image October 31, 2025 - 3_18PM.webp",
  ...
  const featuresData = [
    {
      icon: "/Generated Image October 31, 2025 - 3_16PM.webp",
  ...
  const cards = [
  {
    ...
    desc: "Streamline enterprise operations with end-to-end ERP integration. Automate workflows, centralize data, and enhance decision-making through seamless inter-departmental connectivity.",
    icon: <GiProcessor />,
  },
  {
    title: "CRM Development",
    desc: "Empower your sales and support teams with intelligent, AI-driven CRM solutions. Deliver personalized customer experiences, automate outreach, and boost retention through actionable insights.",
    icon: <MdOutlineManageAccounts />,
  },
  {
    title: "Business Intelligence Dashboards",
    desc: "Transform raw data into real-time insights with interactive BI dashboards. Track KPIs, visualize trends, and make data-backed decisions that drive operational and strategic success.",
    icon: <FaBug />,
  },
  {
    title: "Cloud Optimization",
    desc: "Maximize performance and reduce infrastructure costs with cloud-native architectures. Enable autoscaling, continuous monitoring, and secure deployments across AWS, Azure, or GCP.",
    icon: <GiProcessor />,
  },
];
...
{/* 
      ...
      <InfoSplitSection
        ...
        imageSrc="/Generated Image October 31, 2025 - 3_17PM.webp"
        reverse
      ...
      <CardsSection
        cards={cards}
        stats={stats}
        mapImageSrc="/Generated Image October 31, 2025 - 3_16PM (1).webp"
        legends={legends}
