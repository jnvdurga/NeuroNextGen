...
"[project]/Desktop/NeuroNextGen/NeuroNextGen/src/app/about/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$NeuroNextGen$2f$NeuroNextGen$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AboutUs.useEffect": ()=>{
            ...
            const animateCounters = {
                "AboutUs.useEffect.animateCounters": ()=>{
                    stats.forEach({
                        "AboutUs.useEffect.animateCounters": (stat)=>{
                            let current = 0;
                            const increment = stat.target / 50;
                            const timer = setInterval({
                                "AboutUs.useEffect.animateCounters.timer": ()=>{
                                    current += increment;
                                    ...
                                    setCounters({
                                        "AboutUs.useEffect.animateCounters.timer": (prev)=>({
                                                ...prev,
                                                [stat.key]: Math.floor(current)
                                            })
                                    }["AboutUs.useEffect.animateCounters.timer"]);
                                }
                            }["AboutUs.useEffect.animateCounters.timer"], 30);
                        }
                    }["AboutUs.useEffect.animateCounters"]);
                }
            }["AboutUs.useEffect.animateCounters"];
            ...
            return ({
                "AboutUs.useEffect": ()=>clearTimeout(timer)
            })["AboutUs.useEffect"];
        }
    }["AboutUs.useEffect"], []);
...
_s(AboutUs, "nM4t24zOB4AuzQ+jrkC4cOAqYCM=");
_c = AboutUs;
...
//# sourceMappingURL=Desktop_NeuroNextGen_NeuroNextGen_src_app_about_page_tsx_5dd5c3ce._.js.map