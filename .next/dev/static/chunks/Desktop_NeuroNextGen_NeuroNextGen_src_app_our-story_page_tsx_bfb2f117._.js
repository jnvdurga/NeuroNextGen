...
"[project]/Desktop/NeuroNextGen/NeuroNextGen/src/app/our-story/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$NeuroNextGen$2f$NeuroNextGen$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OurStory.useEffect": ()=>{
            ...
            const animateCounters = {
                "OurStory.useEffect.animateCounters": ()=>{
                    stats.forEach({
                        "OurStory.useEffect.animateCounters": (stat)=>{
                            let current = 0;
                            const increment = stat.target / 50;
                            const timer = setInterval({
                                "OurStory.useEffect.animateCounters.timer": ()=>{
                                    current += increment;
                                    ...
                                    setCounters({
                                        "OurStory.useEffect.animateCounters.timer": (prev)=>({
                                                ...prev,
                                                [stat.key]: Math.floor(current)
                                            })
                                    }["OurStory.useEffect.animateCounters.timer"]);
                                }
                            }["OurStory.useEffect.animateCounters.timer"], 30);
                        }
                    }["OurStory.useEffect.animateCounters"]);
                }
            }["OurStory.useEffect.animateCounters"];
...
_s(OurStory, "nM4t24zOB4AuzQ+jrkC4cOAqYCM=");
_c = OurStory;
...
//# sourceMappingURL=Desktop_NeuroNextGen_NeuroNextGen_src_app_our-story_page_tsx_bfb2f117._.js.map